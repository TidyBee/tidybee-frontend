<template>
  <div>
    <v-btn block class="rounded-rectangle" href="
...
">Configurer l'intégration Google Drive</v-btn>
...
export default {
  ...
  created() {
    ...
    this.grpcClient = new NotionSyncClient("http://0.0.0.0:8081", null, null); /// DID NOT SUCESS TO USE THE .ENV WEIRD
  },
  methods: {
    linkDatabase() {
      if (this.databaseId) {
