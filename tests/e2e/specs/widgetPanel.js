describe("Widget panel usability test", () => {
    it("widgetpanel close & return button works", () => {
        ...
        cy.get(`[data-cy=widgetPanel-Heaviest-btn]`).contains(
            "Top Heaviest Files",
        );
        cy.get(`[data-cy=widgetPanel-Unused-btn]`).contains(
            "Top Unused Files",
        );
        ...
        cy.get(`[data-cy=widget-small-size-btn]`).contains(
            "3x3",
        );
        cy.get(`[data-cy=widget-large-size-btn]`).contains(
            "6x6",
        );
    ...
    it("Add & Delete multiple widget", () => {
        ...
        cy.get(`[data-cy=widget-Heaviest]`).contains(
            "Top Heaviest Files",
        )
        ...
        cy.get(`[data-cy=widget-Unused]`).contains(
            "Top Unused Files",
        )

        cy.get(`[data-cy=widget-Heaviest]`).trigger("mousedown");
        cy.get(`[data-cy=widget-delete-btn-yes]`).contains(
            "yes",
        )
        cy.get(`[data-cy=widget-delete-btn-no]`).contains(
            "no",
        )
    ...
    it("Add Top Missnamed Files widget & don't delete", () => {
        ...
        cy.get(`[data-cy=widget-small-size-btn]`).click();
        cy.get(`[data-cy=widget-Missnamed]`).contains(
            "Top missnamed Files",
        )
